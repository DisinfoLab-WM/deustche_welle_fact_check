...
rss_url = "https://factcheck.bg/feed/"
# Parse RSS Feed
...
for index, entry in enumerate(feed.entries):
    ...
    articles["articles"][str(index)] = {
        ...
        "organization_country": "Bulgaria",  # Assuming the organization is based in the Philippines
        "site_name": "Factcheck.bg",
        "url": entry.link,
        "language": "bg",  
    }
# Save articles to a local JSON file
with open("FactcheckBG.json", "w", encoding='utf-8') as json_file:
    json.dump(articles, json_file, indent=4, ensure_ascii=False)
print("Articles saved locally in Rappler.json!")